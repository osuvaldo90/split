...
- [ ] **Phase 15: Test Infrastructure** - Vitest + convex-test + Playwright configured
- [ ] **Phase 16: Authorization Tests** - Unit tests for all auth boundary checks
- [ ] **Phase 17: Calculation Tests** - Unit tests for split/tax/tip calculations
- [ ] **Phase 18: Mutation Tests** - Unit tests for core mutations and validation
- [ ] **Phase 19: E2E Tests** - Browser automation for host and join flows
...
|-------|----------------|--------|-----------|
| 15. Test Infrastructure | 0/? | Not started | - |
| 16. Authorization Tests | 0/? | Not started | - |
| 17. Calculation Tests | 0/? | Not started | - |
| 18. Mutation Tests | 0/? | Not started | - |
| 19. E2E Tests | 0/? | Not started | - |
